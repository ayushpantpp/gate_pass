...
//if (!empty($arr[0]['VISITOR_TYPE'])) {
                            ...
                            <div class="form-group left-mar">
                                ...
                                <span class="error"> <?php echo $VisitorNameErr; ?></span>
								</div>
                            <div class="form-group left-mar">
                            ...
                            <div class="form-group left-mar">
                                ...
                                <textarea name="MaterialDeclarationBelongings" style="text-transform: uppercase" placeholder="Material Declaration / Belongings..." class="form-last-name form-control" id="MaterialDeclarationBelongings"> <?php if (!empty($arr[0]['BELONGINGS'])) echo $arr[0]['BELONGINGS']; ?></textarea>
                            </div>
